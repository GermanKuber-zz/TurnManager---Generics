...
namespace TurnManager
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var turnManager = new TurnManager<string>(3);
        ...
        private static void Read(TurnManager<string> turnManager)
        {
            while (true)
            {
        ...
        private static void Write(TurnManager<string> turnManager)
        {
